...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
	...
	Page<Appointment> findByClientAndStatusOrderByIdDesc(Pageable pageable, User client, String status);
	...
	List<Appointment> findByAppointmentDateToStringAndStatusOrderByIdDesc(String appointmentDateToString,
			String status);
	...
	Page<Appointment> findByServiceAndValidOrderByIdDesc(Pageable pageable, String service, boolean valid);

	Page<Appointment> findByServiceAndValidOrderByAppointmentDateDesc(Pageable pageable, String service, boolean valid);
